...
import com.mqz.online.edit.config.properties.OSSProperties;
import com.mqz.online.edit.utils.file.FileType;
import com.mqz.online.edit.utils.file.FileTypeJudge;
...
public class OSSUtil {
    ...
    @Resource
    private FileTypeJudge fileTypeJudge;
    ...
    public ResFileDTO uploadDetailInputStream(InputStream in, String fileName, String fileType, long fileSize) {
        ...
        String md5key = this.uploadFile(in, uuidFileName, fileSize, oss.getBucketName(), oss.getDiskName(), fileName);
        ResFileDTO o = new ResFileDTO();
        if (md5key != null) {
